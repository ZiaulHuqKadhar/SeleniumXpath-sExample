...
public class Perumbakkam {
	public static void main(String[] args) {
		...
		WebElement txt = driver.findElement(By.xpath("(//h6[contains(text(),'Greens')])[6]"));
		WebElement txt1 = driver.findElement(By.xpath("//span[contains(text(),'1st Floor, No. 19 &20,')]"));
		WebElement txt2 = driver.findElement(By.xpath("//span[contains(text(),'American Advent Christian Layout,')]"));
		WebElement txt3 = driver.findElement(By.xpath("//span[contains(text(),' Sholinganallur to Medavakkam Main ')]"));
		WebElement txt4 = driver.findElement(By.xpath("//span[contains(text(),'Road,Perumbakkam')]"));
		WebElement txt5 = driver.findElement(By.xpath("//span[contains(text(),' Chennai - 600 100.')]"));
